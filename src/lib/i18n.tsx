...
const translations: Record<Lang, Dict> = {
  bs: {
    ...
    "nav.pricing": "Cjenovnik",
    "pricing.eyebrow": "Cjenovnik",
    "pricing.title": "Jasne cijene, bez iznenađenja.",
    "pricing.subtitle": "Odaberite paket koji odgovara vašim potrebama.",
    "pricing.currency": "KM",
    "pricing.cta": "Odaberi plan",
    "pricing.popular": "Najpopularnije",
    "pricing.basic.name": "Osnovni",
    "pricing.basic.desc": "Idealno za male firme koje žele profesionalno online prisustvo.",
    "pricing.basic.f1": "Jednostavna info / kontakt stranica",
    "pricing.basic.f2": "Osnovne informacije o firmi",
    "pricing.basic.f3": "Responzivan dizajn (mobilni i desktop)",
    "pricing.basic.f4": "Kontakt forma i mapa lokacije",
    "pricing.basic.f5": "SEO optimizacija (osnovna)",
    "pricing.pro.name": "Napredni",
    "pricing.pro.desc": "Za brendove koji žele više od obične prezentacije.",
    "pricing.pro.f1": "Sve iz Osnovnog plana",
    "pricing.pro.f2": "Admin panel za upravljanje sadržajem",
  ...
  en: {
    ...
    "pricing.basic.desc": "Ideal for small businesses that want a professional online presence.",
    "pricing.basic.f1": "Simple info / contact website",
    "pricing.basic.f2": "Core company information",
    "pricing.basic.f3": "Responsive design (mobile & desktop)",
    "pricing.basic.f4": "Contact form and location map",
    "pricing.basic.f5": "Basic SEO optimization",
    "pricing.pro.name": "Advanced",
    "pricing.pro.desc": "For brands that need more than a simple presentation.",
    "pricing.pro.f1": "Everything in the Basic plan",
    "pricing.pro.f2": "Admin panel for content management",
